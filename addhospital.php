            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Manage Hospitals
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="functions/addhospital.php" method="POST">

                            <div class="form-group">
                                <label>Name of hospital</label>
                                <input class="form-control type="text" required="required" name="name" placeholder="Enter Hospital name">
                            </div>

                            <div class="form-group">
                                <label>Area</label>
                                <input class="form-control type="text" required="required" name="area" placeholder="Enter Hospital Area">
                            </div>

                            <div class="form-group">
                                <label>City</label>
                                <input class="form-control type="text" required="required" name="city" placeholder="Enter Hospital City">
                            </div>
                            ...
                            <div>
                                <h4 style="margin-bottom:5px;">Type :</h4>
                                <select id="state" name="type" onchange="" class="frm-field required" style="margin-bottom:5px;width:100%;padding:5px;">
